...
# Video Website Setup Script for Ubuntu
...
check_root() {
    if [[ $EUID -eq 0 ]]; then
        print_warning "Running as root. This is allowed but not recommended for security reasons."
...
install_ffmpeg() {
    ...
    # Install FFmpeg (Ubuntu has it in main repositories)
...
main() {
    echo "=========================================="
    echo "🚀 Video Website Ubuntu Setup Script"
    echo "=========================================="
    echo ""
